 ...
 * */
@Deprecated
public class SetMicrophoneOnHandler extends NoActivityResultMethodHandler {
    public SetMicrophoneOnHandler(@NonNull Activity activity) {
        super(activity);
    }

    @Override
    public String getMethod() {
        return "setMicrophoneOn";
    }
